...
\captionof{figure}{\label{fig:orgd9f3bda}
Axshun Jaxxon}
\end{center}

\begin{enumerate}
\item Personality
\label{sec:org33f853f}
...
\label{sec:orga3b7bf5}
\begin{center}
\includegraphics[width=8cm]{./img/ben-benson.png}
\captionof{figure}{\label{fig:orgea57ea8}
Ben Benson}
\end{center}

\begin{enumerate}
\item Personality
\label{sec:orgaeaf3f1}
...
\label{sec:org023c69a}
\begin{center}
\includegraphics[width=8cm]{./img/yoki-warrior.png}
\captionof{figure}{\label{fig:orgecf6b11}
Yoki Warrior}
\end{center}
...
\captionof{figure}{\label{fig:orgc9c33cd}
The Company.}
\end{center}
...
\captionof{figure}{\label{fig:orgd44649a}
Mittens, the Alien Cat.}
\end{center}

\begin{enumerate}
\item Backstory
\label{sec:orga5c3433}
...
\captionof{figure}{\label{fig:org1409307}
Start Menu}
\end{center}

\begin{center}
\includegraphics[width=8cm]{./img/character-select.png}
\captionof{figure}{\label{fig:org31d7ba5}
Character Select}
\end{center}
...
\captionof{figure}{\label{fig:org38c3bbe}
Page 1}
\end{center}

\begin{center}
\includegraphics[width=8cm]{./img/acrostic-2.png}
\captionof{figure}{\label{fig:orgc3670df}
Page 2}
\end{center}

\begin{center}
\includegraphics[width=8cm]{./img/acrostic-3.png}
\captionof{figure}{\label{fig:org29f31bd}
...
\captionof{figure}{\label{fig:org7955208}
